const spec = {
    ...
    components: {
        schemas: {
            ...
            // para cualquier error: los AppError que tiran las rutas (400/404) y también
            // los inesperados (500), JSON malformado (400), o CastError/ValidationError de Mongoose (400).
            ErrorStatus: {
                type: 'object',
                properties: {
